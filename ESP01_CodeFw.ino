...
const char* ssid2     = "MY_IOT";        //<-- ใส่ชือ Wifi รอง ตรงนี ถ้าใช้ WiFi ตัวเดียวก็ให้ใส่เหมือนกันกับ ssid1
const char* password2 = "0819065291";         //<-- ใส่รหัส Wifi รอง ตรงนี

const char* ssid1     = "duco-mikrotik";        //<-- ใส่ชือ Wifi หลัก
...
String AcctName       = "Ormmy";  //<-- ใส่ชือ User Name ตรงนี
String BrdNm          = "Orm-06"; //<-- ใส่ชือ RigName ตรงนี
