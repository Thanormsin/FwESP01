...
const String FirmwareVer={"2.5"}; 
#define URL_fw_Version "/Thanormsin/FwESP8266/master/bin_version.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/Thanormsin/FwESP8266/master/fw.bin"
...
const long interval = 20000;              // Change Time Firmware ReUpdate
...
const char* USERNAME      = "Thanormsin";     // Change this to your Duino-Coin username
const char* RIG_IDENTIFIER = "ESP01-B0-U01";       // Change this if you want a custom miner name
